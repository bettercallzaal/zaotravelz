# Year of ZAO Festivals - Partnership Tracker

Rule: ZAO organizes ONLY ZAOstock. Every row below = partnership target (we bring entertainment to their event).
Status: IDEA -> CONTACTED -> IN CONVO -> COMMITTED -> DELIVERED -> RECAP SHIPPED
Update this file per touch. One row per event partnership.
...
| ADE Amsterdam | Oct 21-25 | Web3 music battle slot w/ DGTL co-programming | amsterdam-dance-event.nl + DGTL | DROPPED (2026-07-07) | Conflicted with Marfa (Oct 24-26), Marfa wins. Moved to 2027 circuit watchlist below | Zaal |
...
| NFT.NYC | Sep | Return w/ 2026 receipts | nft.nyc | IDEA | After 2026 edition decision | Zaal |
...
|---|---|---|---|
| Coop Records / Sonata (@coopahtroopa) | Onchain music distribution + FC audience | IDEA | DM this week |
| Refraction | Precedent + possible co-curation at Basel | IDEA | Intro via /onchain-music |
| Water & Music | Research/press coverage of circuit | IDEA | Pitch circuit as story |
| Juke (Nicky) | Audio streaming layer | LIVE partner | Ask: circuit audio rail |
| Magnetiq (Tyler) | Proof of Meet at every stop | LIVE partner | Ask: circuit-wide deal |
...
- [x] Rate card - collateral/rate-card.md (Zaal to approve numbers)
